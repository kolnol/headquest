...
public class QuestDialogueNode: QuestGraphNodeSG
{
	...
	init(name: String, description: String, isEnd: Bool = false, backgroundMusicFile: String? = nil, preVoiceSound: String? = nil, postVoiceSound: String? = nil, isSkipable: Bool = false, npc: String)
	{
		self.npc = npc
